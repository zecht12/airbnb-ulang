...
const RentModal = () => {
    ...
    return (
    <Modal isOpen={rentModal.isOpen} onClose={rentModal.onClose} body={bodyContent} onSubmit={handleSubmit(on)} actionLabel={actionLabel} secondaryActionLabel={secondaryActionLabel} secondaryAction={step === STEPS.CATEGORY ? undefined: onBack} title='Travel with us' />
    )
}
