...
const LoginModal = () => {
    ...
    const footerContent=(
        <div className="flex flex-col gap-4">
            <hr/>
            <Buttons outline label="Continue With Google" icon={FcGoogle} onClick={()=> signIn('google')} />
            <Buttons outline label="Continue With Github" icon={AiFillGithub} onClick={()=> signIn('google')} />
